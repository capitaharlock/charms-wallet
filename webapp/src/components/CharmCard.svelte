...
<div class="bg-white rounded-lg shadow-md overflow-hidden transform transition-all duration-200 hover:shadow-lg w-[70%] mx-auto">
  <div class="relative w-full pb-[70%] bg-gray-50">
    ...
    <div class="absolute top-2 right-2 flex space-x-2">
      <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {getTypeColor(charm.app)}">
    ...
    <div class="mt-4 flex flex-col space-y-2">
      ...
      {#if showDetails}
        <div class="mt-2 bg-gray-50 p-3 rounded text-xs font-mono break-all">
          <p class="text-gray-600 mb-1">App VK:</p>
